...
const Page = () => {
    ...
    const handleSignup = async (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault();
        try {
            const hashedPassword = await hashedPass(user.pass);
    ...
    return (
        <div className='py-36 flex items-center h-screen flex-col'> 
            ...
            <div className='border border-black pt-6 sm:p-9 shadow-[-7px_7px_0_#000000]'>
                ...
                <form className='flex flex-col gap-8 px-14 py-10'>    
                    <input 
                        type="email"
                    ...
                    <button 
                        type='submit' 
                        className="font-medium py-1 px-3 sm:py-2 sm:px-3 border text-center border-solid border-black shadow-[-7px_7px_0_#000000]"
                    ...
                    <button 
                        type='submit' 
                        className="font-medium py-1 px-3 justify-around sm:py-2 sm:px-3 border text-center border-solid border-black shadow-[-7px_7px_0_#000000]"
                    >
                        {actions === 'signin' ? " Signin" : "   Signup"}
